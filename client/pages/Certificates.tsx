...
export default function Certificates() {
  const certificates = [
    {
      ...
      date: "2024",
      description: "Comprehensive certification in HR Analytics covering data-driven decision making, metrics analysis, and workforce planning.",
      color: "from-purple-500 to-purple-600",
      skills: ["Data Analysis", "HR Metrics", "Workforce Planning", "Analytics Tools"],
    },
    {
      id: 2,
      ...
      date: "2023",
      description: "Advanced certification in full-cycle recruitment processes, from sourcing to onboarding and retention strategies.",
      color: "from-blue-500 to-blue-600",
      skills: ["Sourcing", "Interviewing", "Onboarding", "Candidate Experience"],
    },
    {
      id: 3,
      ...
      date: "2023",
      description: "Expert-level certification in managing employee relations, compliance, and fostering positive workplace cultures.",
      color: "from-teal-500 to-teal-600",
      skills: ["Employee Relations", "Compliance", "Conflict Resolution", "Culture Building"],
    },
    {
      id: 4,
      ...
      date: "2024",
      description: "Specialized certification in creating and maintaining strong employer brands and attracting top talent.",
      color: "from-pink-500 to-pink-600",
      skills: ["Brand Strategy", "Recruitment Marketing", "EVP Development", "Talent Attraction"],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-8 pb-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-gradient-to-tr from-blue-500 to-purple-500 rounded-full mix-blend-screen filter blur-3xl opacity-30 animate-float" style={{animationDelay: '2s'}}></div>
      <div className="absolute top-1/2 right-0 w-96 h-96 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-float" style={{animationDelay: '4s'}}></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            {[
              ...
              },
              {
                ...
                details: "Regular upskilling in latest HR trends and technologies",
              },
              {
